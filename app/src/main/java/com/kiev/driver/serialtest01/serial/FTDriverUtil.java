package com.kiev.driver.serialtest01.serial;

import android.util.Log;

public class FTDriverUtil {
	// Defines of Display Settings  C:\Users\ina\AndroidStudioProjects\SerialTester\gen\kr\co\djhwang\serialtester\BuildConfig.java
